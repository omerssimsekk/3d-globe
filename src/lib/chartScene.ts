...
export default class ChartScene {
  ...
  init() {
    ...
    this.obControl.enableRotate = false;
    this.obControl.enablePan = false;
    ...
    if (!this._store.config.enableZoom) {
      this.obControl.enableZoom = false;
    }
    this.animate();
